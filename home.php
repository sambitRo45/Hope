                ...
                <div class="card shadow-lg border-0 rounded-4 p-3">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-justify">
                           The vision of HOPE is to create a compassionate world where every elderly person receives care, connection, and emotional support—regardless of where they live. We dream of a society where volunteers and old age homes work hand in hand to bridge the gap between generations. HOPE aims to become the leading platform that unites caring individuals with the elders who need them, building a future where empathy, respect, and kindness guide every interaction.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-5 px-4">
                <div class="card shadow-lg border-0 rounded-4 p-3">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-justify">
                            The mission of HOPE is to connect dedicated volunteers with old age homes that require companionship, assistance, and emotional support for their residents. Our platform makes it easy for volunteers to discover opportunities, participate in meaningful activities, and bring joy to senior citizens. We strive to empower old age homes by providing them access to a reliable network of helpers, ensuring that no elder feels forgotten or alone. Through technology and humanity.
                        </p>
                    </div>
                </div>
            </div>
